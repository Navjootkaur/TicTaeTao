...
import com.navjoot.tictaetao.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun checkForVictory(s: String): Boolean
    {
        ...
        if (match(binding.a1,s) && match(binding.a2,s) && match(binding.a3,s) )
            ...
            return true
        else if (match(binding.c1,s) && match(binding.c2,s) && match(binding.c3,s) )
            return true
